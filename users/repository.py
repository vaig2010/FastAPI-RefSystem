...
class UserRepository:
    ...
    @classmethod
    async def get_user_refcode(cls, session: AsyncSession, user_id: int) -> ReferallCode:
    ...
    @classmethod
    async def update_users_code_id(cls, session: AsyncSession, user: User, refcode: ReferallCode) -> User:
